...
WEB_BUILD_NO_CACHE=--no-cache

export TARGET_ENV TARGET_BRANCH API_CONTAINER API_BACKUP_CONTAINER API_ENV_FILE API_BACKUP_ENV_FILE API_IMAGE_PREFIX API_PORT_ARGS API_NETWORK_ALIAS WEB_CONTAINER WEB_IMAGE_PREFIX WEB_HOST_PORT WEB_API_UPSTREAM WEB_BUILD_ARGS WEB_BUILD_NO_CACHE
