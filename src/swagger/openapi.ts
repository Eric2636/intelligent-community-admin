    ...
    schemas: {
      ...
      PublishMallItemBody: {
        ...
        properties: {
          ...
          wechatContact: { type: 'string', maxLength: 100, description: '微信号，微信号和手机号至少填写一项' },
          phoneContact: { type: 'string', pattern: '^1[3-9]\\d{9}$', description: '中国大陆手机号，微信号和手机号至少填写一项' },
          phoneIsWechat: { type: 'boolean', description: '手机号是否也是微信号；为 true 时必须同时填写 phoneContact' },
          contact: { type: 'string', maxLength: 500, deprecated: true, description: '历史联系方式字段，仅兼容旧客户端' },
      ...
      UpdateMallItemBody: {
        ...
        properties: {
          ...
          unit: { type: 'string', maxLength: 16 },
          desc: { type: 'string', maxLength: 8000 },
          wechatContact: { type: ['string', 'null'], maxLength: 100 },
          phoneContact: { type: ['string', 'null'], pattern: '^1[3-9]\\d{9}$' },
          phoneIsWechat: { type: 'boolean', description: '手机号是否也是微信号；为 true 时必须同时填写 phoneContact' },
          contact: { type: ['string', 'null'], maxLength: 500, deprecated: true, description: '历史联系方式字段，仅兼容旧客户端' },
